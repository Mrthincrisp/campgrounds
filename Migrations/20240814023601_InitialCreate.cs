    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "getbaked@gmail.com", "John", "Doe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://www.discovercrystalriverfl.com/imager/s3_us-east-1_amazonaws_com/crystalriver-2019/images/attractions/RV-Camping-in-Rock-Crusher-RV-Resort1-1_bc0d2157d501d4729a3d5631708a6b2e.jpg", "Barred Owl" },
                    { 3, 3, "https://dec.ny.gov/sites/default/files/styles/hero_background/public/2023-11/PrimitiveASD1.jpg?h=2f15d14c&itok=HbFnKfKL", "Barred Owl" },
                    { 4, 4, "https://www.hammockuniverse.com/cdn/shop/articles/Hammock-Universe-Blog-Featured-Image-10-TIPS-FOR-HAMMOCK-CAMPING-LIKE-A-PRO_900x.jpg?v=1678808670", "Barred Owl" },
                    { 5, 4, "https://www.rei.com/dam/content_team_042618_0128_hammock_setup.jpg", "Barred Owl" },
                    { 6, 1, "https://images.pexels.com/photos/1687845/pexels-photo-1687845.jpeg?auto=compress&cs=tinysrgb&w=600", "Barred Owl" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 3, new DateTime(2025, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 }
                });
